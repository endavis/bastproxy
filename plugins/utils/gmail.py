...
class Plugin(BasePlugin):
  ...
  def initialize(self):
    ...
    parser.add_argument('password',
                        ...
                        default='', nargs='?')
    self.api('core.commands:command:add')('password', self.cmd_pw, showinhistory=False,
                                          parser=parser)
  ...
  def api_send(self, subject, msg, mailto=None):
    ...
    if self.check():
      if self.api('setting:get')('server') == 'smtp.gmail.com':
  ...
  def checkpassword(self, _):
    ...
    if self.api('setting:get')('username'):
      if not self.password:
        ...
        self.api('libs.io:send:client')('#bp.mail.password "somepassword"')
