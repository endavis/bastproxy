...
class TestCallbackBasics:
    ...
    def test_callback_creation(self) -> None:
        ...
        callback = Callback(
            name="test_callback", owner_id="test_owner", func=helper_test_function
        )
    ...
    def test_callback_string_representation(self) -> None:
        ...
        callback = Callback(
            name="test_cb", owner_id="test_owner", func=helper_test_function
        )
...
class TestCallbackExecution:
    ...
    def test_execute_callback_without_args(self) -> None:
        ...
        callback = Callback(
            name="exec_callback", owner_id="test_owner", func=helper_test_function
        )
    ...
    def test_execute_increments_raised_count(self) -> None:
        ...
        callback = Callback(
            name="count_callback", owner_id="test_owner", func=helper_test_function
        )
    ...
    def test_execute_updates_last_raised_time(self) -> None:
        ...
        callback = Callback(
            name="time_callback", owner_id="test_owner", func=helper_test_function
        )
...
class TestCallbackEquality:
    ...
    def test_callback_hash(self) -> None:
        ...
        callback = Callback(
            name="hash_callback", owner_id="test_owner", func=helper_test_function
        )
    ...
    def test_different_callbacks_different_hashes(self) -> None:
        ...
        callback1 = Callback(
            name="callback1", owner_id="owner1", func=helper_test_function
        )
        callback2 = Callback(
            name="callback2", owner_id="owner2", func=another_test_function
        )
    ...
    def test_callback_identity(self) -> None:
        ...
        callback = Callback(
            name="self_callback", owner_id="test_owner", func=helper_test_function
        )
    ...
    def test_callback_equals_wrapped_function(self) -> None:
        ...
        callback = Callback(
            name="func_callback", owner_id="test_owner", func=helper_test_function
        )
    ...
    def test_callback_not_equals_different_function(self) -> None:
        ...
        callback = Callback(
            name="diff_callback", owner_id="test_owner", func=helper_test_function
        )
